...
const Login = () => {
    ...
    return (
        <div className="flex h-screen items-center justify-center p-6 bg-gradient-to-r from-rose-400 to-red-500">
              ...
              <h1 className="hidden md:block text-4xl font-bold text-white">LNMIIT BUS APP</h1>

  </header>
  <div className="flex bg-white rounded-lg shadow-lg overflow-hidden w-full md:max-w-3xl">
    {/* Illustration div, hidden on small screens */}
    <div className="illustration hidden md:block w-3/5 mt-28">
        <img 
            src={busappvecjpeg} 
            alt="illustration" 
    ...
    {/* Form div, always visible */}
    <div className="form flex flex-col p-6 w-full md:w-2/5"> 
